...
where 
    match_type_number = 4682;

--v1 get the team id (361 deliveries/bowls)
select 
...
where d.match_type_number = 4682;

--v2 get the player id
select
     d.match_type_number as match_id,
     td.team_id, td.team_name,
     bpd.player_id as batter_id, bpd.player_name,
     spd.player_id batter_id, spd.player_name,
...
select
     d.match_type_number as match_id,
     td.team_id, td.team_name,
     bpd.player_id as batter_id, bpd.player_name as bowler,
     spd.player_id batter_id, spd.player_name as stricker,
     nspd.player_id as non_stricker_id, nspd.player_name as non_striker,
     d.over,
     d.runs,
     d.extra_runs,
     d.extra_type
